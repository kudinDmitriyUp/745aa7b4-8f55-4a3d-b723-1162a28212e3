...
export const metadata: Metadata = {
  title: "Grand Elegance Hotel - Luxury Accommodations & World-Class Service",
  description: "Experience unparalleled luxury at Grand Elegance Hotel. Premium suites, award-winning dining, spa services, and exceptional hospitality for discerning travelers.",
  keywords: "luxury hotel, premium accommodations, five star hotel, luxury suites, fine dining, spa services, concierge, business travel, romantic getaway",
  metadataBase: new URL("https://grandelegancehotel.com"),
  alternates: {
    canonical: "https://grandelegancehotel.com"
  },
  openGraph: {
    title: "Grand Elegance Hotel - Luxury Redefined",
    description: "Indulge in unparalleled elegance and world-class hospitality at our premium hotel destination.",
    url: "https://grandelegancehotel.com",
    siteName: "Grand Elegance Hotel",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763326688931-k4x2rjh3.jpg",
      alt: "Grand Elegance Hotel luxury lobby"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Grand Elegance Hotel - Luxury Accommodations",
    description: "Experience unparalleled luxury and world-class service at our premium hotel.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763326688931-k4x2rjh3.jpg"]
  },
  robots: {
    index: true,
    follow: true
